# 📊 Product Weekly — W53 · 2025-12-29 → 2026-01-04

> **Généré automatiquement le** : 18 avril 2026
> **Versions publiées** : ? → ? (0 releases)
> **PRs mergées** : 6 | **Commits directs** : 19
...
**#335 — Claude/review backlog alignment 3 ld y3**

**#333 — feat(server): Implement January 2026 P1 features**

**#332 — Claude/audit team setup t a6a x**
...
- `ded2118` fix(auth): Safari mobile support via Authorization header fallback
- `5817603` fix(auth): Add Authorization header fallback for mobile Safari
- `6660cfb` fix(auth): Fix race condition after login redirect
  _… +2 autres commits_

**admin** (2 commits)

- `73560d7` feat(admin): add bulk video categorization and thumbnail regeneration
- `84392a4` fix(admin): Fix cache.invalidateNamespace method call

**remote** (2 commits)

- `af4cba7` refactor(remote): optimize SCSS and adjust Angular budgets
- `433db91` fix(remote): Fix category and video count in telecommande

**overlay** (2 commits)

- `3280b1a` fix(overlay): Fix preview position for 9-position overlay system
- `f412646` feat(overlay): Major V2 with multi-sport support and animations

**testing** (1 commits)

- `788a883` feat(testing): add comprehensive test dashboard and toolkit

**login** (1 commits)

- `c8892d5` feat(login): display club info on login pages (ports 80 & 8080)

**ci** (1 commits)

- `d763138` feat(ci): implement automatic semantic versioning

**changelog** (1 commits)

- `d5657bb` docs(changelog): add bulk categorization and thumbnail regeneration features

**setup** (1 commits)

- `475ce26` fix(setup): generate config in dashboard-compatible format

**raspberry** (1 commits)

- `c0691fe` fix(raspberry): Enable Socket.IO offline mode for autonomous operation

**ui** (1 commits)

- `89af4d3` fix(ui): Fix language selector dropdown on login pages

**core** (1 commits)

- `83955ad` feat(core): Migrate Sponsor → Advertiser (Annonceur) terminology

---

## 6. DOCS & CHORES

**#337 — docs(claude): create comprehensive CLAUDE.md for project context ** ✅

> Create comprehensive `CLAUDE.md` file (1051 lines) providing complete project context for Claude Code.

**#336 — docs: Document P1 January 2026 features from review branch**

**#334 — docs: Align backlog and status with December 2025 sprint completion**
...
| **6 PR(s)** sans section "Impact client" renseignée                              | Faible      | Faible (rapport incomplet, BO mal informé) | Remplir rétrospectivement ou accepter comme dette de processus            |
...
2. [PROCESSUS] 6 PR(s) utilisent l'ancien template (pas d'"Impact client"). Remettre à jour ou accepter ?
...
| #                      | Titre                                                        | Type    | Mergé le   |
| ---------------------- | ------------------------------------------------------------ | ------- | ---------- |
| [#337](../../pull/337) | docs(claude): create comprehensive CLAUDE.md for project con | doc     | 2026-01-03 |
| [#336](../../pull/336) | docs: Document P1 January 2026 features from review branch   | doc     | 2026-01-01 |
| [#335](../../pull/335) | Claude/review backlog alignment 3 ld y3                      | feature | 2026-01-01 |
| [#334](../../pull/334) | docs: Align backlog and status with December 2025 sprint com | doc     | 2026-01-01 |
| [#333](../../pull/333) | feat(server): Implement January 2026 P1 features             | feature | 2025-12-30 |
| [#332](../../pull/332) | Claude/audit team setup t a6a x                              | feature | 2025-12-29 |
