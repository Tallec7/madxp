...
```bash
$ curl https://neopro-central-production.up.railway.app/socket.io/?EIO=4&transport=polling
...
```bash
$ curl https://neopro-central-production.up.railway.app/socket.io/?EIO=4&transport=polling
0{"sid":"abc123...","upgrades":["websocket"],"pingInterval":10000,"pingTimeout":20000}
```
...
5. Verify health: https://neopro-central-production.up.railway.app/health
```
...
1. **Test Socket.IO connectivity** in CI/CD:
   ...
   ```bash
   curl -f "https://neopro-central-production.up.railway.app/socket.io/?EIO=4&transport=polling"
   ```
