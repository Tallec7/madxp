...
- **api:** correct column names in timeline endpoint ([520fb46](https://github.com/Tallec7/neopro/commit/520fb460581019f69e091cd71258ec65ec7feb62))
...
- **dashboard:** use ngIf instead of ternary for translate pipe ([6f1473a](https://github.com/Tallec7/neopro/commit/6f1473af90ca9f42d3d990e3c95e0eb4a9efe10b))
...
- **debug:** use getLogs endpoint instead of sendCommand for logs ([b833ae2](https://github.com/Tallec7/neopro/commit/b833ae26121fec116d3c3a2b0a3eabdb53d78328))
...
- **sync-agent:** use commands reference instead of this for method calls ([ee3ca12](https://github.com/Tallec7/neopro/commit/ee3ca1227984dbc2d5c9a9aa7183501d9d10ad9a))
...
- **debug:** add dedicated endpoint for network diagnostics ([16224fc](https://github.com/Tallec7/neopro/commit/16224fca05f3eabc1bf299d2b993a03dde5ebf0f))
- **debug:** add dedicated endpoints for health status and diagnostics ([dd58864](https://github.com/Tallec7/neopro/commit/dd58864457a89a149bd8e93ceb27f9b2db77edcd))
...
- **kiosk:** add Raspberry Pi 5 support with SwiftShader ([a9745e1](https://github.com/Tallec7/neopro/commit/a9745e1ce2911d9fddd3abfb10cfeadbebca28be))
