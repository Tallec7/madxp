...
**Touchpoints Neopro** : Dashboard super_admin (gestion sites, users, contenus, advertisers, monitoring) + Grafana + Slack alerts + accès SSH Pi en dernier recours
...
**Touchpoints Neopro** : Dashboard admin (vue parc, gestion sites/users), monitoring temps réel (heartbeat Pi, status Pi/SaaS), commandes remote (restart kiosk, rotate PSK, etc.)
...
**Touchpoints Neopro** : Mail trimestriel automatique (rapport stratégique club), accès dashboard club en lecture (KPI agrégés, jamais le Studio), Remote en tribune les soirs de gala — délègue tout l'opérationnel à 3b/3c.
...
- Niveau 1 : Neopro produit tout (shooting photo, shooting vidéo, contenus). Il valide et diffuse. _(upsell service)_
- Niveau 2 : personnalise les templates Neopro dans le Studio (couleurs, logo, noms joueurs)
- Niveau 3 : crée from scratch dans le Studio. Vision long terme.

**Programmation / diffusion**

- Niveau 1 : Neopro configure les scénarios matchday pour lui _(upsell service)_
...
- **Offre Pi** : Neopro fournit le boîtier, résilience offline, watchdog réseau. Argument d'entrée sur l'anxiété matchday. Une fois autonome et confiant, le club peut évoluer vers le full SaaS.
...
- Sans Neopro : plusieurs boucles sur plusieurs PC, synchronisation manuelle, plusieurs opérateurs nécessaires le jour du match

---

**Points de douleur sans Neopro**

- **Diffusion et programmation** : savoir quoi diffuser quand est un casse-tête permanent — gérer les phases match (avant, pendant, mi-temps, après), les rotations sponsors, les annonces club. Sans Neopro c'est manuel ou inexistant. Douleur quotidienne la plus fréquente, avant même la création.
...
- **Coordination avec l'écran physique** : est-ce que ce qui est programmé s'affiche vraiment ? Est-ce que le Pi tourne ? Aucune visibilité sans Neopro. Anxiété réelle la nuit avant un match.
...
**Moment "wow" avec Neopro** _(selon le profil)_

- **Niveau service** : "Neopro m'a livré mes contenus, je les ai mis en ligne en 10 minutes, le match a tourné tout seul — je n'ai rien eu à créer."
...
- Assets photo/vidéo livrés par Neopro (réutilisables RS)
- Service shooting photo + vidéo Neopro _(upsell — niveau service)_
- Service configuration scénarios Neopro _(upsell — niveau service)_
...
- Niveau 1 : prospecte seul sans support Neopro
- Niveau 2 : utilise les données Neopro comme outil de vente en RDV
- Niveau 3 _(vision moyen terme)_ : Neopro l'aide activement à identifier des prospects potentiels
...
**Ce que Neopro transforme dans son métier**

Neopro ne remplace pas tous les supports physiques — il **transforme l'écran en support vendable et prouvable** :

**Ce que Neopro remplace :**
...
**Trois moments dans sa relation avec Neopro**

**Avant le RDV prospect** — prépare son argumentaire avec les données Neopro (impressions, taux de présence, comparatif packs). Neopro est son dossier de vente.

**Pendant le RDV** — sort le dashboard ou un PDF en live pour convaincre. Neopro est sa preuve.

**Après la signature** — onboard le nouveau sponsor, configure sa rotation, les rapports partent automatiquement. Neopro est son back-office.
...
**Ce que Neopro lui apporte en vision cible**
...
- **Branding** : le spectateur voit-il le QR code Neopro ou le QR code du club ? Impact sur la collecte de données et la marque Neopro.
...
**Niveau 2 — Direct sponsor** : un sponsor paie pour financer le jeu concours — son logo sur le QR code, son produit comme lot. Le spectateur est l'audience, le sponsor est l'annonceur, Neopro est le média.

**Niveau 3 — Direct partenaire externe** : un acteur sport-entertainment paie pour accéder à l'audience Neopro et animer ses propres expériences. Neopro devient une plateforme ouverte.
...
**En une phrase** : l'entreprise, marque ou institution qui achète de la visibilité dans le gymnase du club — du spot ponctuel sans engagement au partenariat pluriannuel — dont la relation est gérée exclusivement par le club via Neopro.

---

**Qui c'est — spectre de la relation**

_Mêmes touchpoints Neopro, nature de relation et niveau d'exigence croissants._
...
**Touchpoints Neopro selon le niveau**
...
- **PME locale** : "Mon directeur m'a demandé de justifier nos 5K€ de sponsoring — j'ai sorti le PDF Neopro en réunion, ça a clos le débat."
...
- **Institutionnel** : "J'annexe le rapport semestriel Neopro à notre convention — quand un élu demande 'qu'est-ce qu'on a en retour ?', j'ai une réponse certifiée."
...
**En une phrase** : la marque nationale ou inter-régionale qui achète de la visibilité sur le réseau de gymnases Neopro directement — sans passer par les clubs — en échange d'un reversement automatique aux clubs qui diffusent ses spots.
...
| ------------------- | --------------------- | ----------------------------- |
| Relation            | Club ↔ Marque         | Neopro ↔ Marque               |
| Géré par            | 3c (resp partenaires) | Neopro                        |
...
**Aujourd'hui — régie manuelle Neopro**
L'annonceur passe par l'équipe Neopro qui gère sa campagne manuellement.
...
- Neopro reverse 10-20% aux clubs qui diffusent — automatiquement, sans intervention club
...
- **Aujourd'hui** : "J'uploade ma vidéo une fois chez Neopro, elle tourne dans 5 gymnases le week-end suivant — j'ai un rapport d'impressions consolidé en fin de mois sans avoir contacté un seul club."
...
**Touchpoints Neopro** : équipe Neopro (régie manuelle aujourd'hui) → portail annonceur → dashboard régie complet (long terme)
...
**En une phrase** : agence sport-marketing locale ou régionale qui gère plusieurs clubs simultanément pour le compte de ses clients — partenaire commercial et opérationnel de Neopro qui apporte des clubs en volume en échange d'un accès consolidé et d'un tarif préférentiel.
...
**Position dans la chaîne Neopro**

**Canal de distribution** : elle embarque plusieurs clubs d'un coup — chaque club signé via une agence est un abonnement Neopro sans effort commercial direct.

**Consommatrice de services** : elle commande des upsells en volume pour ses clubs (shooting, production, templates) — revenus services récurrents pour Neopro.
...
- Contrat partenaire formel avec Neopro : exclusivité territoriale possible
...
**En une phrase** : l'autorité institutionnelle sportive (ligue régionale, comité départemental, fédération nationale) qui prescrit Neopro à ses clubs affiliés en échange d'une commission, pousse des contenus et partenariats nationaux dans le réseau, et exploite les données agrégées de ses clubs comme actif stratégique.
...
- Dashboard fédération : vue agrégée de tous ses clubs affiliés Neopro
...
- Ce mécanisme crée un engagement contractuel fort — levier de volume ET de discipline réseau pour Neopro

---

**Moment "wow"**

- **Prescription** : "Je signe un accord avec Neopro — mes 28 clubs ont accès à un tarif préférentiel et je touche 12% sur chaque abonnement. Je n'ai rien à gérer au quotidien."
...
- Contrat partenaire Neopro (commission, exclusivité, conditions)
...
**Risque à documenter** : club "subi" via prescription fédérale = engagement produit potentiellement plus faible qu'un club qui a choisi Neopro activement. À compenser par onboarding renforcé et démonstration de valeur rapide.
...
**En une phrase** : la personne qui met en service le dispositif Neopro dans le gymnase et assure la maintenance technique ongoing à distance — premier maillon de la chaîne après la vente, garant de l'expérience de 3b dès le jour 1.

---

**Qui c'est**

Aujourd'hui : l'équipe Neopro elle-même. À terme : réseau de techniciens partenaires locaux formés par Neopro, ou le club lui-même si et seulement si la procédure est suffisamment robuste.
...
- Travaille sous supervision de **l'équipe Neopro** (super admin / admin support)

**Statut** : 🟡 partiellement couvert aujourd'hui (SSH + intervention équipe Neopro) — remote shell et monitoring technicien sont la priorité produit, le wizard UI ne l'est pas
...
- [ ] Trancher branding QR code spectateur (Neopro vs club) avant développement roadmap 6/9 mois
