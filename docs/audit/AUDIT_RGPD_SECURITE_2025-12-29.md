...
L'application MADXP n'est **pas** une application de suivi de joueurs sportifs avec données de santé. C'est un **système de gestion et diffusion de contenu vidéo** sur des écrans TV dans des clubs sportifs via des Raspberry Pi.
...
- **Responsable** : La société exploitant MADXP
- **Sous-traitants** :
...
_Aucun identifié_ - L'application peut être lancée légalement.
...
```markdown
# Conditions Générales d'Utilisation MADXP
...
```markdown
# Conditions Générales de Vente MADXP - Offre Clubs
...
_Document généré le 29 décembre 2025_
_Équipe d'audit : Juriste RGPD, Expert Sécurité, Ingénieur Produit_
