...
> **Dernière mise à jour** : 20 Avril 2026 (ADR-074 Template Studio v2 — Sprint 1 backbone : migration DB, API super_admin CRUD, runtime data-driven Remotion, 6 animation presets, métrique Prometheus `neopro_template_studio_operations_total`)
...
| Métrique                  | Valeur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Features implémentées** | **245** (+26 audit, +9 E-22 TV+Secondary dual, +6 sponsor UX, +2 résilience Pi/OTA, +3 hotspot WiFi, +3 debug page, +1 EDID enrichment, +1 dashboard EDID display, +1 OTA edid-decode, +1 sysfs fix, +1 ADR-068 signed URL proxy SaaS, +1 ADR-069 Delivery Strategy pattern, +8 sprint 17-18/04 : 3 ADR-058 phases 2A-2C + 3 Remote V2 (ADR-060/061/062) + 1 ADR-063 socket filter + 1 ADR-068 supervision, +3 sprint 19/04 : ADR-073 security hardening hotspot (SEC-18, NET-20, PI-41), **+1 sprint 20/04 : ADR-074 Template Studio v2 backbone (IMP-VID-19)**) |
