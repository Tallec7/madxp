...
> **Dernière mise à jour** : 20 Avril 2026 (ADR-075 Template Studio v2 — Sprints 7-8 white-glove hardening : seed idempotent + E2E + upload direct 📁 dans admin panels + dossier FTP `template-assets/studio/` isolé + 14 nouveaux smoke guards)
...
| Métrique                  | Valeur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Features implémentées** | **248** (+26 audit, +9 E-22 TV+Secondary dual, +6 sponsor UX, +2 résilience Pi/OTA, +3 hotspot WiFi, +3 debug page, +1 EDID enrichment, +1 dashboard EDID display, +1 OTA edid-decode, +1 sysfs fix, +1 ADR-068 signed URL proxy SaaS, +1 ADR-069 Delivery Strategy pattern, +8 sprint 17-18/04 : 3 ADR-058 phases 2A-2C + 3 Remote V2 (ADR-060/061/062) + 1 ADR-063 socket filter + 1 ADR-068 supervision, +3 sprint 19/04 : ADR-073 security hardening hotspot (SEC-18, NET-20, PI-41), **+4 sprint 20/04 : ADR-075 Template Studio v2 backbone + white-glove club scoping + Sprint 7 hardening + Sprint 8 upload direct admin panels (IMP-VID-19→22)**) |
