...
> **Dernière mise à jour** : 20 Avril 2026 (ADR-075 Template Studio v2 — Sprint 6 white-glove club scoping : colonne `site_id` nullable, filtre galerie "Mes templates perso", badge Club, feature gate Premium `template_studio_club_scoped`, render-time guard tier + site)
...
| Métrique                  | Valeur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Features implémentées** | **246** (+26 audit, +9 E-22 TV+Secondary dual, +6 sponsor UX, +2 résilience Pi/OTA, +3 hotspot WiFi, +3 debug page, +1 EDID enrichment, +1 dashboard EDID display, +1 OTA edid-decode, +1 sysfs fix, +1 ADR-068 signed URL proxy SaaS, +1 ADR-069 Delivery Strategy pattern, +8 sprint 17-18/04 : 3 ADR-058 phases 2A-2C + 3 Remote V2 (ADR-060/061/062) + 1 ADR-063 socket filter + 1 ADR-068 supervision, +3 sprint 19/04 : ADR-073 security hardening hotspot (SEC-18, NET-20, PI-41), **+2 sprint 20/04 : ADR-075 Template Studio v2 backbone + white-glove club scoping (IMP-VID-19, IMP-VID-20)**) |
