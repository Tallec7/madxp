...
def build_features_us(wb):
    ...
    features_pi2 = [
        ...
        ("E-15", "F-15.1", "Int\u00e9gration API f\u00e9d\u00e9rations sportives", 4, "Hold", "PI-2 (Avr-Jun 2025)", ""),
        ("E-15", "F-15.2", "Lecture directe table de marque multi-constructeurs (Stramatel, Bodet, OCR)", 1, "Backlog", "PI-2 (Avr-Mai 2026)", ""),
        ...
        ("E-21", "F-21.2", "API publique Neopro Live Scores (REST + WebSocket + Webhooks)", 2, "Backlog", "PI-3 (Juin-Juil 2026)", ""),
