...
> **Je cherche…**
>
> - _comment une vidéo arrive sur la TV_ → [[#Flux Vidéo]]
> - _comment un match est géré_ → [[#Domaine Match & Scoreboard]]
> - _pourquoi un Pi ne se connecte pas_ → [Troubleshooting](../guides/TROUBLESHOOTING.md)
> - _un ADR spécifique_ → [[#Index ADR par domaine]]
> - _quel fichier fait quoi_ → [[#Index des fichiers clés]]
