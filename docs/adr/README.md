...
| [ADR-092](ADR-092-match-sessions-persistence-and-history.md)                    | Persistance des sessions de match — extension `club_sessions` + auto-close CRON  | Accepté                           | Avr 2026 |
