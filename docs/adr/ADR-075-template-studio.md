...
**Date** : 2026-04-20
**Statut** : Accepté — MVP livré (Sprints 1→4) + V2 white-glove complet (Sprints 5–9, site-scoped templates + Premium gate + upload direct 📁 + canvas format picker + curated fonts)
