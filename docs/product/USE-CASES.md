...
>
> **Statut** : Live | **Dernière revue** : 2026-05-01 | **Source** : [PERSONAE.md](../PERSONAE.md) + [SPECs métier](../specs/) + interviews terrain Daisy
>
...
| Cas d'usage **mono-persona**                 | _Que fait-elle dans son métier au quotidien ?_                      | Section "Spectre d'autonomie" inline dans `PERSONAE.md` (cf. 3b niveaux 1-3, 3c niveaux 1-3) |
