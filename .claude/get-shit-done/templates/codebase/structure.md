...
- Usage: Reference from command with `@/Users/gletallec/Documents/NEOPRO/neopro/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/gletallec/Documents/NEOPRO/neopro/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/gletallec/Documents/NEOPRO/neopro/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
