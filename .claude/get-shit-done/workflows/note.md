...
- **Global scope**: `/Users/gletallec/Documents/NEOPRO/neopro/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gletallec/Documents/NEOPRO/neopro/.claude/notes/`)
...
2. Glob `/Users/gletallec/Documents/NEOPRO/neopro/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gletallec/Documents/NEOPRO/neopro/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gletallec/Documents/NEOPRO/neopro/.claude/notes/` — works in any directory
