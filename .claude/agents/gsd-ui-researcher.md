...
Use template from `/Users/gletallec/Documents/NEOPRO/neopro/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/gletallec/Documents/NEOPRO/neopro/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/gletallec/Documents/NEOPRO/neopro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
