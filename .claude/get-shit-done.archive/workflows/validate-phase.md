...
```bash
AUDITOR_MODEL=$(node "/Users/gletallec/Documents/NEOPRO/neopro/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-nyquist-auditor --raw)
NYQUIST_CFG=$(node "/Users/gletallec/Documents/NEOPRO/neopro/.claude/get-shit-done/bin/gsd-tools.cjs" config get workflow.nyquist_validation --raw)
```
...
```
Task(
  prompt="Read /Users/gletallec/Documents/NEOPRO/neopro/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
1. Read template from `/Users/gletallec/Documents/NEOPRO/neopro/.claude/get-shit-done/templates/VALIDATION.md`
...
node "/Users/gletallec/Documents/NEOPRO/neopro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(phase-${PHASE}): add/update validation strategy"
```
