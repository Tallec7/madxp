...
COMMENT ON COLUMN madxp_templates.canvas_width  IS 'ADR-075 : largeur canvas Remotion (px). Défaut 1920 (16:9 TV).';
COMMENT ON COLUMN madxp_templates.canvas_height IS 'ADR-075 : hauteur canvas Remotion (px). Défaut 1080 (16:9 TV).';
