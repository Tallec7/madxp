...
import { authenticate, authenticateSiteApiKeyOptional, requireRole, requireClubPermission } from '../middleware/auth';
...
router.get('/clubs/:siteId/health', authenticate, requireClubPermission('view_status'), validateParams(paramSchemas.siteId), analyticsController.getClubHealth);

// GET /api/analytics/clubs/:siteId/availability - Historique disponibilité
router.get('/clubs/:siteId/availability', authenticate, requireClubPermission('view_status'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.analyticsClub), analyticsController.getClubAvailability);

// GET /api/analytics/clubs/:siteId/alerts - Historique alertes
router.get('/clubs/:siteId/alerts', authenticate, requireClubPermission('view_status'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.analyticsAlerts), analyticsController.getClubAlerts);
...
router.get('/clubs/:siteId/usage', authenticate, requireClubPermission('view_analytics'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.analyticsClub), analyticsController.getClubUsage);

// GET /api/analytics/clubs/:siteId/content - Analytics contenu
router.get('/clubs/:siteId/content', authenticate, requireClubPermission('view_analytics'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.analyticsClub), analyticsController.getClubContent);

// GET /api/analytics/clubs/:siteId/sources - Répartition kiosk (Pi) vs PC (E-23 US-23.7.4)
router.get('/clubs/:siteId/sources', authenticate, requireClubPermission('view_analytics'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.analyticsClub), analyticsController.getClubSourceBreakdown);
...
router.get('/clubs/:siteId/dashboard', authenticate, requireClubPermission('view_analytics'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.dateRange), analyticsController.getClubDashboard);

// GET /api/analytics/clubs/:siteId/export - Export CSV
router.get('/clubs/:siteId/export', authenticate, requireClubPermission('view_analytics'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.analyticsExport), analyticsController.exportClubData);

// GET /api/analytics/clubs/:siteId/report/pdf - Générer rapport PDF
router.get('/clubs/:siteId/report/pdf', authenticate, requireClubPermission('view_analytics'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.dateRange), analyticsController.generateClubPdfReport);

// GET /api/analytics/clubs/:siteId/export/excel - Export Excel avancé club
router.get('/clubs/:siteId/export/excel', authenticate, requireClubPermission('view_analytics'), validateParams(paramSchemas.siteId), validateQuery(querySchemas.dateRange), analyticsController.exportClubExcel);
