...
// Remotion asset Cache-Control guard (ADR-052) supprimé avec le kill du
// data-driven legacy — cf. ADR-129. Le serving statique des WebM/MP4 via
// /remotion-preview a disparu en même temps que le package templates-remotion.
