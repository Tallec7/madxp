...
export {
  ...
  type StudioAssetRow,
  type CreateStudioAssetInput,
  type UpdateStudioAssetMetadataInput,
  type StudioAssetListFilters,
  type StudioAssetUsageRow,
  type TemplateAssetBindingRow,
  type UpsertTemplateAssetBindingInput,
