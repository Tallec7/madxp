...
const joueurSimpleGeneriqueTestProps: TemplateRuntimeProps = {
  ...
  textFields: [
    ...
    },
    {
      ...
      fontFamily: 'GeneralSans', fontSize: 28, color: 'rgba(255,255,255,0.7)', align: 'center',
      appearAt: 2.76, appearDuration: 0.5, animation: 'none', animationDirection: 'in',
...
const joueurSimpleImageTestProps: TemplateRuntimeProps = {
  ...
  textFields: [
    ...
    },
    {
      ...
      fontFamily: 'GeneralSans', fontSize: 28, color: 'rgba(255,255,255,0.7)', align: 'left',
    ...
    },
    {
      ...
      fontFamily: 'GeneralSans', fontSize: 28, color: 'rgba(255,255,255,0.7)', align: 'right',
      appearAt: 0, appearDuration: 0.6, animation: 'fade', animationDirection: 'in',
      scaleFrom: 1.0, scaleTo: 1.0,
      layerId: 'p', respectAlpha: false,
      textTransform: 'uppercase', letterSpacing: 10,
