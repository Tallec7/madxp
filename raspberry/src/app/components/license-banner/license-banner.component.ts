 ...
 *
 * Composant de bannière d'avertissement affiché sur /remote quand la licence a un warning.
 * Affiche un message contextuel sans bloquer l'utilisation.
 */
import { Component, Input, Output, EventEmitter } from '@angular/core';
import { CommonModule } from '@angular/common';
import { LicenseState, LicenseStatus } from '../../services/license.service';
...
@Component({
  ...
  styles: [`
    ...
    @media (max-width: 480px) {
      ...
      .banner-days {
        display: none; /* Cacher sur mobile pour gagner de l'espace */
      }
    }
  `]
})
export class LicenseBannerComponent {
  ...
  /**
   * Événement émis quand la bannière est fermée
   */
  ...
  /**
   * Retourne le message selon le statut
   */
  getMessage(): string {
  ...
  /**
   * Retourne l'info sur les jours (pour affichage compact)
   */
