...
export interface PiConfigVideoEntry {
    ...
    /** ADR-088 — Type de contenu (vidéo par défaut, web_page ou livestream) */
    contentType?: 'video' | 'web_page' | 'livestream';
    /** ADR-088 — URL externe pour web_page / livestream */
    externalUrl?: string;
    /** ADR-088 — Durée en secondes pour les web_page (durée auto-close) */
